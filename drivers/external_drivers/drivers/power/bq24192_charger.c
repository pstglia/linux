...
#define DEV_NAME_COMPATIBLE "bq24196"
...
enum bq24192_chip_type {
	...
	BQ24192I, BQ24296, BQ24297,BQ24196
};
					...
					const union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_INLMT:
		...
		dev_info(&bq24192_client->dev,"input current inlmt: %d", chip->inlmt);
		if (!ret)
			...
			union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_INLMT:
		...
		dev_info(&bq24192_client->dev,"get_input_current_inlmt: %d", chip->inlmt);
		break;
	case POWER_SUPPLY_PROP_CHARGE_TERM_CUR:
...
static int bq24192_get_chip_version(struct bq24192_chip *chip)
{
	...
	case BQ24297_IC_VERSION:
		chip->chip_type = BQ24297;
		break;
	case BQ24196_IC_VERSION:
		chip->chip_type = BQ24196;
		break;
	default:
		dev_err(&chip->client->dev,
