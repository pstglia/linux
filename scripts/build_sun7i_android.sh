...
#export CROSS_COMPILE="/home/paulo/ANDROID/FONTES/GALAXY_TAB_SM113/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androidkernel-"
export CROSS_COMPILE="/home/paulo/ANDROID/FONTES/BPI-A20-Android/lichee/brandy/gcc-linaro/bin/arm-linux-gnueabi-"
...
build_nand_lib()
{
	if [ "${BOOT_VERSION}" = "1.0" ]; then
		...
		echo -e "\033[0;31;1m#  your data is incorrect,please build project again  #\033[0m"
		echo -e "\033[0;31;1m################################################\033[0m"
		exit 1
	fi
...
build_modules()
{
    ...
    make -C ${NAND_ROOT} LICHEE_MOD_DIR=${LICHEE_MOD_DIR} LICHEE_KDIR=${LICHEE_KDIR} \
        install
...
echo "use nand version=""$BOOT_VERSION"
case "$1" in
    kernel)
        build_kernel
        ;;
