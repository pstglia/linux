...
static struct misensor_reg const ov5645_320p_init[] = {
	{MISENSOR_8BIT, 0x3C07, 0x08},
	{MISENSOR_8BIT, 0x3820, 0x47},
	{MISENSOR_8BIT, 0x3821, 0x01},	/* enable binning */
	{MISENSOR_8BIT, 0x3814, 0x31},
...
static struct misensor_reg const ov5645_vga_init[] = {		
        ...
        {MISENSOR_8BIT, 0x3a03, 0x60},
        {MISENSOR_8BIT, 0x3a08, 0x01},
        {MISENSOR_8BIT, 0x3a09, 0x6c},
        {MISENSOR_8BIT, 0x3a0a, 0x01},
        {MISENSOR_8BIT, 0x3a0b, 0x58},
        {MISENSOR_8BIT, 0x3a0e, 0x03},
        {MISENSOR_8BIT, 0x3a0d, 0x04},
        {MISENSOR_8BIT, 0x3a14, 0x04},
        {MISENSOR_8BIT, 0x3a15, 0x44},
        {MISENSOR_8BIT, 0x3a18, 0x00},
        {MISENSOR_8BIT, 0x3a19, 0xf8},
        {MISENSOR_8BIT, 0x4004, 0x02},
        {MISENSOR_8BIT, 0x4005, 0x18},
...
static struct misensor_reg const ov5645_init[] = {
	...
	{MISENSOR_8BIT,0x5181, 0xf6},
	{MISENSOR_8BIT,0x5182, 0x00},
	{MISENSOR_8BIT,0x5183, 0x14},
	{MISENSOR_8BIT,0x5184, 0x25},
	{MISENSOR_8BIT,0x5185, 0x24},
	{MISENSOR_8BIT,0x5186, 0x14},
	{MISENSOR_8BIT,0x5187, 0x27},
	{MISENSOR_8BIT,0x5188, 0x1a},
	{MISENSOR_8BIT,0x5189, 0x7c},
	{MISENSOR_8BIT,0x518a, 0x5b},
	{MISENSOR_8BIT,0x518b, 0x9e},
	{MISENSOR_8BIT,0x518c, 0x8d},
	{MISENSOR_8BIT,0x518d, 0x3c},
	{MISENSOR_8BIT,0x518e, 0x37},
	{MISENSOR_8BIT,0x518f, 0x54},
	...
	{MISENSOR_8BIT,0x5199, 0xe9},
	{MISENSOR_8BIT,0x519a, 0x04},
	{MISENSOR_8BIT,0x519b, 0x00},
	{MISENSOR_8BIT,0x519c, 0x04},
	{MISENSOR_8BIT,0x519d, 0x59},
	{MISENSOR_8BIT,0x519e, 0x38},


	//matrix	
	{MISENSOR_8BIT,0x5381, 0x26},
	{MISENSOR_8BIT,0x5382, 0x4E},
	{MISENSOR_8BIT,0x5383, 0x0C},
	{MISENSOR_8BIT,0x5384, 0x12},
	{MISENSOR_8BIT,0x5385, 0x74},
	{MISENSOR_8BIT,0x5386, 0x86},
	{MISENSOR_8BIT,0x5387, 0x90},
	{MISENSOR_8BIT,0x5388, 0x81},
	{MISENSOR_8BIT,0x5389, 0x0F},
	...
	{MISENSOR_8BIT,0x538B, 0x98},
        ...
        {MISENSOR_8BIT, 0x5302, 0x18},//sharpness
	...
	//gamma
	{MISENSOR_8BIT,0x5481, 0x0B},
	{MISENSOR_8BIT,0x5482, 0x15},
	{MISENSOR_8BIT,0x5483, 0x29},
	{MISENSOR_8BIT,0x5484, 0x4B},
	{MISENSOR_8BIT,0x5485, 0x58},
	{MISENSOR_8BIT,0x5486, 0x65},
	{MISENSOR_8BIT,0x5487, 0x72},
	{MISENSOR_8BIT,0x5488, 0x7C},
	{MISENSOR_8BIT,0x5489, 0x86},
	{MISENSOR_8BIT,0x548A, 0x8F},
	{MISENSOR_8BIT,0x548B, 0x9F},
	{MISENSOR_8BIT,0x548C, 0xAE},
	{MISENSOR_8BIT,0x548D, 0xC6},
	{MISENSOR_8BIT,0x548E, 0xDA},
	...
	{MISENSOR_8BIT,0x5490, 0x1D},
        ...
        {MISENSOR_8BIT, 0x5584, 0x30},
        {MISENSOR_8BIT, 0x5589, 0x10},
        {MISENSOR_8BIT, 0x558a, 0x00},
        {MISENSOR_8BIT, 0x558b, 0xf8},

	//lens
	{MISENSOR_8BIT,0x5800, 0x27},
	{MISENSOR_8BIT,0x5801, 0x13},
	{MISENSOR_8BIT,0x5802, 0x10},
	{MISENSOR_8BIT,0x5803, 0x10},
	{MISENSOR_8BIT,0x5804, 0x17},
	{MISENSOR_8BIT,0x5805, 0x2f},
	{MISENSOR_8BIT,0x5806, 0x0e},
	{MISENSOR_8BIT,0x5807, 0x08},
	{MISENSOR_8BIT,0x5808, 0x05},
	{MISENSOR_8BIT,0x5809, 0x06},
	{MISENSOR_8BIT,0x580a, 0x08},
	{MISENSOR_8BIT,0x580b, 0x0f},
	{MISENSOR_8BIT,0x580c, 0x09},
	{MISENSOR_8BIT,0x580d, 0x02},
	{MISENSOR_8BIT,0x580e, 0x00},
	{MISENSOR_8BIT,0x580f, 0x00},
	{MISENSOR_8BIT,0x5810, 0x04},
	{MISENSOR_8BIT,0x5811, 0x0a},
	{MISENSOR_8BIT,0x5812, 0x09},
	{MISENSOR_8BIT,0x5813, 0x03},
	{MISENSOR_8BIT,0x5814, 0x00},
	{MISENSOR_8BIT,0x5815, 0x01},
	{MISENSOR_8BIT,0x5816, 0x04},
	{MISENSOR_8BIT,0x5817, 0x0b},
	{MISENSOR_8BIT,0x5818, 0x0f},
	{MISENSOR_8BIT,0x5819, 0x08},
	{MISENSOR_8BIT,0x581a, 0x06},
	{MISENSOR_8BIT,0x581b, 0x06},
	{MISENSOR_8BIT,0x581c, 0x0a},
	{MISENSOR_8BIT,0x581d, 0x0f},
	{MISENSOR_8BIT,0x581e, 0x23},
	{MISENSOR_8BIT,0x581f, 0x17},
	{MISENSOR_8BIT,0x5820, 0x12},
	{MISENSOR_8BIT,0x5821, 0x14},
	{MISENSOR_8BIT,0x5822, 0x18},
	{MISENSOR_8BIT,0x5823, 0x37},
	{MISENSOR_8BIT,0x5824, 0x26},
	{MISENSOR_8BIT,0x5825, 0x0a},
	{MISENSOR_8BIT,0x5826, 0x0c},
	{MISENSOR_8BIT,0x5827, 0x0a},
	{MISENSOR_8BIT,0x5828, 0x28},
	{MISENSOR_8BIT,0x5829, 0x0a},
	{MISENSOR_8BIT,0x582a, 0x28},
	{MISENSOR_8BIT,0x582b, 0x24},
	{MISENSOR_8BIT,0x582c, 0x08},
	{MISENSOR_8BIT,0x582d, 0x0a},
	{MISENSOR_8BIT,0x582e, 0x2a},
	{MISENSOR_8BIT,0x582f, 0x22},
	{MISENSOR_8BIT,0x5830, 0x20},
	{MISENSOR_8BIT,0x5831, 0x02},
	{MISENSOR_8BIT,0x5832, 0x0a},
	{MISENSOR_8BIT,0x5833, 0x08},
	{MISENSOR_8BIT,0x5834, 0x08},
	{MISENSOR_8BIT,0x5835, 0x04},
	{MISENSOR_8BIT,0x5836, 0x08},
	{MISENSOR_8BIT,0x5837, 0x0a},
	{MISENSOR_8BIT,0x5838, 0x2c},
	{MISENSOR_8BIT,0x5839, 0x0a},
	{MISENSOR_8BIT,0x583a, 0x0c},
	{MISENSOR_8BIT,0x583b, 0x0a},
	{MISENSOR_8BIT,0x583c, 0x48},
