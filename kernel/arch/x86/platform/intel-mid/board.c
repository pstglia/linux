...
#include "device_libs/platform_ft5506.h"
#include "device_libs/platform_ft5416.h"
#include "device_libs/platform_ekth3250.h"
 /*SPI devices
 */
...
#include "device_libs/platform_s5k5cagx.h"
...
struct devs_id __initconst device_ids[] = {
	...
	{"bq27425", SFI_DEV_TYPE_I2C, 0, &bq27x00_platform_data, NULL},
	{"bq24192", SFI_DEV_TYPE_I2C, 1, &bq24192_platform_data},
	{"bq24196", SFI_DEV_TYPE_I2C, 1, &bq24192_platform_data},
	...
	*/
	...
	{"ov5693", SFI_DEV_TYPE_I2C, 0, &ov5693_platform_data,
					&intel_register_i2c_camera_device},
        {"s5k5cagx", SFI_DEV_TYPE_I2C, 0, &s5k5cagx_platform_data,
					&intel_register_i2c_camera_device},
	...
	{"audience_es305", SFI_DEV_TYPE_I2C, 0, &audience_platform_data,
						NULL},
	{"ft5506", SFI_DEV_TYPE_I2C, 0, &ft5506_platform_data, NULL},
	{"ft5416", SFI_DEV_TYPE_I2C, 0, &ft5416_platform_data, NULL},
	{"ektf2k", SFI_DEV_TYPE_I2C, 0, &ekthf2k_platform_data, NULL},
